...
public:
	...
	// Renders object
	void RenderMesh(glm::vec3 scaleArray, glm::vec3 posArray, glm::vec3 rotArrray, glm::vec2 UVArray, std::string texture, std::string material, int meshID, glm::vec3 cylArray);
