 ...
 ***********************************************************/
void ViewManager::Mouse_Scroll_Wheel_Callback(GLFWwindow* window, double xScrollDistance, double yScrollDistance)
{
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	// switch the view mode to orthographic
	if (glfwGetKey(m_pWindow, GLFW_KEY_O) == GLFW_PRESS)
	{
		bOrthographicProjection = true;
	}

	// switch the view mode to perspective
...
void ViewManager::PrepareSceneView()
{
	...
	{
		projection = glm::ortho(-10.0f, 10.0f, -8.0f, 8.0f, 0.0f, 100.0f);
		glViewport(-100, 100, 1000, 800);
